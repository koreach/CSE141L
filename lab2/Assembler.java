 ...
 *  CSE141L Lab2                             *
 *                                           *
 *  This program takes in an assembly file   *
 *  and produces the its translation to      *
 *  machine code.                            *
 *********************************************/
...
public class Assembler{
  ...
  public static void assemble(File inputfile){
    try{
      //set up a filereader and bufferedreader to get file contents
      ...
      while (line != null){
        ...
        ///////////////////////////////////////////
        //read in instructions from adder.txt    //
        ///////////////////////////////////////////
        else{
    ...
    //catch any buffered reader exceptions
    catch(IOException e){
      System.out.println();
      Assembler.separator();
